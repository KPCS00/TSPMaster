...
public interface IEmailService
{
    ...
    Task SendDailyRecommendationEmailAsync(string toEmail, string firstName, string recommendationSummary, string actionAdvice, int remainingTransfers, string currentMonth);
}
